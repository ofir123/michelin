...
import logbook
from michelin import config as michelin_config
...
def post_fork(server, worker):
    ...
    logging_rotating_file_handler = logging.handlers.RotatingFileHandler(
        michelin_config.LOG_FILE_PATH.replace('.log', f'.{worker.pid}.flask.log'),
    ...
    logger_setup = logbook.NestedSetup([
        ...
        logbook.RotatingFileHandler(michelin_config.LOG_FILE_PATH.replace('.log', f'.{worker.pid}.log'),
